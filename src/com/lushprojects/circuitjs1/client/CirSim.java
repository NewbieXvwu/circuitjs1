...
//    Class dumpTypes[], shortcuts[];
    ...
    static final int MENUBARHEIGHT=64;
...
//    String baseURL = "http://www.falstad.com/circuit/";
    ...
    if (!hideMenu) {
        ...
        topAppBarWrapper.add(topAppBar);

        Label appTitle = new Label(LS("CircuitJS1"));
        appTitle.addStyleName("md3-top-app-bar__title");
        topAppBar.add(appTitle);

        FlowPanel menuContainer = new FlowPanel();
        menuContainer.addStyleName("md3-top-app-bar__menu");
        menuContainer.add(menuBar);
        topAppBar.add(menuContainer);

        layoutPanel.addNorth(topAppBarWrapper, MENUBARHEIGHT);
    }
